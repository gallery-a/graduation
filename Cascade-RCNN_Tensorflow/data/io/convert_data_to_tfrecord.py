...
tf.app.flags.DEFINE_string('VOC_dir', '/data/xuelangplus1/', 'Voc dir')
...
tf.app.flags.DEFINE_string('save_dir', '/data/tfrecord/', 'save name')
tf.app.flags.DEFINE_string('img_format', '.jpg', 'format of image')
tf.app.flags.DEFINE_string('dataset', 'xuelangplus1', 'dataset')
...
def convert_pascal_to_tfrecord():
    ...
    xml_path = path + FLAGS.VOC_dir + FLAGS.save_name+FLAGS.xml_dir
    image_path = path + FLAGS.VOC_dir + FLAGS.save_name + FLAGS.image_dir
    save_path = path + FLAGS.save_dir + FLAGS.dataset + '_' + FLAGS.save_name + '.tfrecord'
