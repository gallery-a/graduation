...
# ------------------------------------------------
VERSION = 'FasterRCNN_20191223_v2_resnet_v1_101_class7_plus_2'#'FasterRCNN_20181207_v2_resnet101'
...
EPSILON = 1e-5
MOMENTUM = 0.9
LR = 0.0003#0.001 # 0.001  # 0.0003
DECAY_STEP = [50000, 70000]  # 50000, 70000
MAX_ITERATION = 200000

# -------------------------------------------- Data_preprocess_config
DATASET_NAME = 'xuelangplus7'  # 'ship', 'spacenet', 'pascal', 'coco'
