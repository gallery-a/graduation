...
parser.add_argument('--relu-targets', nargs='+', type=str, dest='relu_targets',help='List of reluX_1 layers, corresponding to --checkpoints', required=True)
...
parser.add_argument('--style-size', type=int, dest='style_size', help="Resize style image to this size before cropping, default 512", default=0)
...
#parser.add_argument('--filename ', type=str, help='Path to vgg_normalised.t7', default='')
...
def main():
    ...
    for content_fullpath in content_files:
        ...
        for style_fullpath in style_files: 
            ...
            out_f = os.path.join(args.out_path, '{}_{}_relu_{}_alpha_{}_resize_{}{}'.format(content_prefix, style_prefix,args.relu_targets,args.alpha, args.style_size, content_ext))
